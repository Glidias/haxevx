...
/**
 * TODO Roadmap:
 (i figured the below system provides the most flexibility to accomodate different coding  styles for different projects...and provide full-blown Immutable type-safety/access-control at compile time)
