...
haxevx_vuex_examples_shoppingcart_components_CartVue.prototype = $extend(haxevx_vuex_core_VxComponent.prototype,{
	...
	,checkout: function(products) {
		var _this = haxevx_vuex_examples_shoppingcart_components_CartVue.action;
		var context = this.$store;
		context.dispatch("haxevx_vuex_examples_shoppingcart_modules_CartDispatcher|checkout",products,null);
	}
	,Template: function() {
...
haxevx_vuex_examples_shoppingcart_components_ProductListVue.prototype = $extend(haxevx_vuex_core_VxComponent.prototype,{
	...
	,addToCart: function(p) {
		var _this = haxevx_vuex_examples_shoppingcart_components_ProductListVue.actionDispatcher;
		var context = this.$store;
		context.dispatch("haxevx_vuex_examples_shoppingcart_store_AppActions|addToCart",p,null);
	}
	,Created: function() {
		var _this = haxevx_vuex_examples_shoppingcart_components_ProductListVue.dispatcher;
		var context = this.$store;
		context.dispatch("haxevx_vuex_examples_shoppingcart_modules_ProductListDispatcher|getAllProducts",null,null);
	}
	,Template: function() {
...
haxevx_vuex_examples_shoppingcart_modules_CartDispatcher.prototype = {
	checkout: function(context,payload) {
		...
		var _this = haxevx_vuex_examples_shoppingcart_modules_CartDispatcher.mutator;
		...
		haxevx_vuex_examples_shoppingcart_modules_CartDispatcher.shop.buyProducts(payload,function() {
			var _this1 = haxevx_vuex_examples_shoppingcart_modules_CartDispatcher.mutator;
			context.commit("haxevx_vuex_examples_shoppingcart_store_AppMutator|checkoutSuccess",null,null);
		},function() {
			var _this2 = haxevx_vuex_examples_shoppingcart_modules_CartDispatcher.mutator;
			var payload1 = { savedCartItems : savedCartItems};
			context.commit("haxevx_vuex_examples_shoppingcart_store_AppMutator|checkoutFailure",payload1,null);
		});
	}
	,_checkout: function(context,payload,opts,ns) {
		...
		if(ns != "") {
			context.dispatch(ns + "haxevx_vuex_examples_shoppingcart_modules_CartDispatcher|checkout",payload,opts);
		} else {
			context.dispatch("haxevx_vuex_examples_shoppingcart_modules_CartDispatcher|checkout",payload,opts);
		}
	}
...
haxevx_vuex_examples_shoppingcart_store_AppMutator.prototype = {
	...
	,_addToCart: function(context,payload,opts,ns) {
		...
		if(ns != "") {
			context.commit(ns + "haxevx_vuex_examples_shoppingcart_store_AppMutator|addToCart",payload,opts);
		} else {
			context.commit("haxevx_vuex_examples_shoppingcart_store_AppMutator|addToCart",payload,opts);
		}
	}
	,_checkoutRequest: function(context,opts,ns) {
		...
		if(ns != "") {
			context.commit(ns + "haxevx_vuex_examples_shoppingcart_store_AppMutator|checkoutRequest",null,opts);
		} else {
			context.commit("haxevx_vuex_examples_shoppingcart_store_AppMutator|checkoutRequest",null,opts);
		}
	}
	,_checkoutSuccess: function(context,opts,ns) {
		...
		if(ns != "") {
			context.commit(ns + "haxevx_vuex_examples_shoppingcart_store_AppMutator|checkoutSuccess",null,opts);
		} else {
			context.commit("haxevx_vuex_examples_shoppingcart_store_AppMutator|checkoutSuccess",null,opts);
		}
	}
	,_checkoutFailure: function(context,payload,opts,ns) {
		...
		if(ns != "") {
			context.commit(ns + "haxevx_vuex_examples_shoppingcart_store_AppMutator|checkoutFailure",payload,opts);
		} else {
			context.commit("haxevx_vuex_examples_shoppingcart_store_AppMutator|checkoutFailure",payload,opts);
		}
	}
	,_receiveProducts: function(context,payload,opts,ns) {
		...
		if(ns != "") {
			context.commit(ns + "haxevx_vuex_examples_shoppingcart_store_AppMutator|receiveProducts",payload,opts);
		} else {
			context.commit("haxevx_vuex_examples_shoppingcart_store_AppMutator|receiveProducts",payload,opts);
		}
	}
	,_SetInto: function(d,ns) {
...
haxevx_vuex_examples_shoppingcart_modules_ProductListDispatcher.prototype = {
	getAllProducts: function(context) {
		haxevx_vuex_examples_shoppingcart_modules_ProductListDispatcher.shop.getProducts(function(products) {
			var _this = haxevx_vuex_examples_shoppingcart_modules_ProductListDispatcher.mutator;
	...
	,_getAllProducts: function(context,opts,ns) {
		...
		if(ns != "") {
			context.dispatch(ns + "haxevx_vuex_examples_shoppingcart_modules_ProductListDispatcher|getAllProducts",null,opts);
		} else {
			context.dispatch("haxevx_vuex_examples_shoppingcart_modules_ProductListDispatcher|getAllProducts",null,opts);
		}
	}
	,_SetInto: function(d,ns) {
...
haxevx_vuex_examples_shoppingcart_store_AppActions.prototype = {
	addToCart: function(context,payload) {
		if(payload.inventory > 0) {
			var _this = haxevx_vuex_examples_shoppingcart_store_AppActions.mutator;
			var payload1 = { id : payload.id};
			context.commit("haxevx_vuex_examples_shoppingcart_store_AppMutator|addToCart",payload1,null);
		}
	}
	,_addToCart: function(context,payload,opts,ns) {
		if(ns == null) {
		...
		if(ns != "") {
			context.dispatch(ns + "haxevx_vuex_examples_shoppingcart_store_AppActions|addToCart",payload,opts);
		} else {
			context.dispatch("haxevx_vuex_examples_shoppingcart_store_AppActions|addToCart",payload,opts);
		}
	}
	,_SetInto: function(d,ns) {
