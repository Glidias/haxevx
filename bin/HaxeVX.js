...
haxevx_vuex_core_VxBoot.start = function(rootVue,store,otherComponents) {
	return new Vue(rootVue._toNative());
};
...
var haxevx_vuex_examples_shoppingcart_ShoppingCartMain = function() {
	haxevx_vuex_core_VxBoot.start(new haxevx_vuex_examples_shoppingcart_components_App(),new haxevx_vuex_examples_shoppingcart_store_AppStore());
};
...
haxevx_vuex_examples_shoppingcart_components_CartVuePropHelper.getCartProducts = function(store) {
	return store.gettersProxy.get_cartProducts();
};
...
haxevx_vuex_examples_shoppingcart_components_ProductListPropHelper.products = function(store) {
