...
var haxevx_vuex_examples_shoppingcart_modules_ProductList = function() {
	this.state = new haxevx_vuex_examples_shoppingcart_modules_ProductListModel();
};
haxevx_vuex_examples_shoppingcart_modules_ProductList.getAllProducts = function(state) {
	return state.all;
};
haxevx_vuex_examples_shoppingcart_modules_ProductList.__super__ = haxevx_vuex_core_VModule;
haxevx_vuex_examples_shoppingcart_modules_ProductList.prototype = $extend(haxevx_vuex_core_VModule.prototype,{
	get_allProducts: function() {
		return haxevx_vuex_examples_shoppingcart_modules_ProductList.getAllProducts(this.state);
	}
});
	...
	checkout: function(product) {
		...
		return function(context,payload) {
			if(product.inventory > 0) {
				_gthis.mutator.addToCart({ id : product.id});
			}
		};
	}
};
