...
haxevx_vuex_examples_shoppingcart_components_CartVue.prototype = $extend(haxevx_vuex_core_VxComponent.prototype,{
	...
	,checkout: function(products) {
		this.$store.dispatch("haxevx_vuex_examples_shoppingcart_modules_CartDispatcher|checkout",products,null);
	}
	,Template: function() {
...
haxevx_vuex_examples_shoppingcart_components_ProductListVue.prototype = $extend(haxevx_vuex_core_VxComponent.prototype,{
	...
	,addToCart: function(p) {
		this.$store.dispatch("haxevx_vuex_examples_shoppingcart_store_AppActions|addToCart",p,null);
	}
	,Created: function() {
		this.$store.dispatch("haxevx_vuex_examples_shoppingcart_modules_ProductListDispatcher|getAllProducts",null,null);
	}
	,Template: function() {
