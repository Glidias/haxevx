...
haxevx_vuex_core_IPrefixedState.prototype = {
	__class__: haxevx_vuex_core_IPrefixedState
};
...
haxevx_vuex_core_Singletons.addLookup = function(classeName,from) {
	var arr;
	if(haxevx_vuex_core_Singletons.NAMES.exists(classeName)) arr = haxevx_vuex_core_Singletons.NAMES.get(classeName); else {
		arr = [];
		haxevx_vuex_core_Singletons.NAMES.set(classeName,arr);
	}
	arr.push(from);
};
haxevx_vuex_core_Singletons.setAsSingleton = function(instance) {
	haxevx_vuex_core_Singletons.SINGLETON_CACHE.set(Type.getClassName(Type.getClass(instance)),instance);
	return instance;
};
haxevx_vuex_core_Singletons.getSingleton = function(classeName) {
	return haxevx_vuex_core_Singletons.SINGLETON_CACHE.get(classeName);
};
...
haxevx_vuex_core_Singletons.clearLookups = function() {
	var $it0 = haxevx_vuex_core_Singletons.NAMES.keys();
	while( $it0.hasNext() ) {
		var k = $it0.next();
		if(haxevx_vuex_core_Singletons.SINGLETON_CACHE.get(k) == null) console.log("Warning:: Could not find singleton dependency from/to: [" + Std.string(haxevx_vuex_core_Singletons.NAMES.get(k)) + "] -> " + k);
	}
...
haxevx_vuex_examples_shoppingcart_components_CartVue.prototype = $extend(haxevx_vuex_core_VxComponent.prototype,{
	...
	,checkout: function(products) {
		haxevx_vuex_examples_shoppingcart_components_CartVue.action._checkout(this.$store,products,null,null);
	}
	,Template: function() {
...
haxevx_vuex_examples_shoppingcart_components_ProductListVue.prototype = $extend(haxevx_vuex_core_VxComponent.prototype,{
	...
	,addToCart: function(p) {
		haxevx_vuex_examples_shoppingcart_components_ProductListVue.actionDispatcher._addToCart(this.$store,p,null,null);
	}
	,Created: function() {
		haxevx_vuex_examples_shoppingcart_components_ProductListVue.dispatcher._getAllProducts(this.$store,null,null);
	}
	,Template: function() {
...
haxevx_vuex_examples_shoppingcart_modules_CartDispatcher.prototype = {
	checkout: function(context,payload) {
		...
		context.commit("haxevx_vuex_examples_shoppingcart_store_AppMutator|checkoutRequest",null,null);
		haxevx_vuex_examples_shoppingcart_modules_CartDispatcher.shop.buyProducts(payload,function() {
			context.commit("haxevx_vuex_examples_shoppingcart_store_AppMutator|checkoutSuccess",null,null);
		},function() {
			haxevx_vuex_examples_shoppingcart_modules_CartDispatcher.mutator._checkoutFailure(context,{ savedCartItems : savedCartItems},null,null);
		});
	}
	,_checkout: function(context,payload,opts,ns) {
		if(ns == null) ns = "";
		if(ns != "") context.dispatch(ns + "haxevx_vuex_examples_shoppingcart_modules_CartDispatcher|checkout",payload,opts); else context.dispatch("haxevx_vuex_examples_shoppingcart_modules_CartDispatcher|checkout",payload,opts);
	}
...
haxevx_vuex_examples_shoppingcart_store_AppMutator.prototype = {
	...
	,_addToCart: function(context,payload,opts,ns) {
		if(ns == null) ns = "";
		if(ns != "") context.commit(ns + "haxevx_vuex_examples_shoppingcart_store_AppMutator|addToCart",payload,opts); else context.commit("haxevx_vuex_examples_shoppingcart_store_AppMutator|addToCart",payload,opts);
	}
	,_checkoutRequest: function(context,opts,ns) {
		if(ns == null) ns = "";
		if(ns != "") context.commit(ns + "haxevx_vuex_examples_shoppingcart_store_AppMutator|checkoutRequest",null,opts); else context.commit("haxevx_vuex_examples_shoppingcart_store_AppMutator|checkoutRequest",null,opts);
	}
	,_checkoutSuccess: function(context,opts,ns) {
		if(ns == null) ns = "";
		if(ns != "") context.commit(ns + "haxevx_vuex_examples_shoppingcart_store_AppMutator|checkoutSuccess",null,opts); else context.commit("haxevx_vuex_examples_shoppingcart_store_AppMutator|checkoutSuccess",null,opts);
	}
	,_checkoutFailure: function(context,payload,opts,ns) {
		if(ns == null) ns = "";
		if(ns != "") context.commit(ns + "haxevx_vuex_examples_shoppingcart_store_AppMutator|checkoutFailure",payload,opts); else context.commit("haxevx_vuex_examples_shoppingcart_store_AppMutator|checkoutFailure",payload,opts);
	}
	,_receiveProducts: function(context,payload,opts,ns) {
		if(ns == null) ns = "";
		if(ns != "") context.commit(ns + "haxevx_vuex_examples_shoppingcart_store_AppMutator|receiveProducts",payload,opts); else context.commit("haxevx_vuex_examples_shoppingcart_store_AppMutator|receiveProducts",payload,opts);
	}
	,_SetInto: function(d,ns) {
...
haxevx_vuex_examples_shoppingcart_modules_ProductListDispatcher.prototype = {
	getAllProducts: function(context) {
		haxevx_vuex_examples_shoppingcart_modules_ProductListDispatcher.shop.getProducts(function(products) {
			context.commit("haxevx_vuex_examples_shoppingcart_store_AppMutator|receiveProducts",products,null);
		});
	}
	,_getAllProducts: function(context,opts,ns) {
		if(ns == null) ns = "";
		if(ns != "") context.dispatch(ns + "haxevx_vuex_examples_shoppingcart_modules_ProductListDispatcher|getAllProducts",null,opts); else context.dispatch("haxevx_vuex_examples_shoppingcart_modules_ProductListDispatcher|getAllProducts",null,opts);
	}
	,_SetInto: function(d,ns) {
...
haxevx_vuex_examples_shoppingcart_store_AppActions.prototype = {
	addToCart: function(context,payload) {
		if(payload.inventory > 0) haxevx_vuex_examples_shoppingcart_store_AppActions.mutator._addToCart(context,{ id : payload.id},null,null);
	}
	,_addToCart: function(context,payload,opts,ns) {
		if(ns == null) ns = "";
		if(ns != "") context.dispatch(ns + "haxevx_vuex_examples_shoppingcart_store_AppActions|addToCart",payload,opts); else context.dispatch("haxevx_vuex_examples_shoppingcart_store_AppActions|addToCart",payload,opts);
	}
	,_SetInto: function(d,ns) {
